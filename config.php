...
define("BACKUP_DIR", "backup");//服务器端备份路径
// 网站地址
define('SERVER_PATH', dirname('http://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']) . '/');
// server 跟地址
define('SERVER_ROOT_DIRECTORY', dirname(SERVER_PATH) . '/');
...
$MONGO["servers"][$i]["mongo_port"]    = "10008";//mongo port
